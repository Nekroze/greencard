...
greencard could always use more documentation, whether as part of the 
official greencard docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
To run a subset of tests::
	...
	$ python -m unittest tests.test_greencard
